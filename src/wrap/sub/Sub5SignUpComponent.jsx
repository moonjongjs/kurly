...
export default function Sub5SignUpComponent() {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regexp2.test(value)===false || regexp3.test(value)===true || regexp4.test(value)===true  ||  regexp5.test(value)===false ){
            ...
            axios({
                url:'https://moonjong.co.kr/kurly_green/kurly_id_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn=(e)=>{
        ...
        if(value===''){
            ...
            axios({
                url:'https://moonjong.co.kr/kurly_green/kurly_email_duplicate_ok.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onClickIdOk=(e)=>{
        ...
        axios({
            url:'https://moonjong.co.kr/kurly_green/kurly_id_ok.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    const onSubmitForm=(e)=>{
        ...
        if(state.아이디===''){
            ...
            axios({
                url: 'https://moonjong.co.kr/kurly_green/kurly_insert.php',
                method: 'POST',
